    ...
    <div className="container mx-auto px-4 py-16 max-w-3xl text-center">
      ...
      >
        ...
        <h1 className="text-4xl md:text-5xl font-sans font-bold text-foreground mb-8">
          The destination for high-quality guest content.
        </h1>
        
        <div className="prose prose-lg mx-auto text-muted-foreground">
          <p className="text-xl leading-relaxed mb-8">
            GuestPost Hub is a premier publishing platform dedicated to editorial excellence and professional insights. 
            We provide a modern home for experts to share their knowledge with a global audience.
          </p>
          <p>
            Our platform focuses on clean, minimal design and exceptional typography to ensure your message is delivered clearly and professionally.
          </p>
        </div>
